...
export class AddTechnology {
   ...
   createEntry(bikeModel, bikeRate, Description)
   {
      ...
      .subscribe((data) =>
      {
         ...
         {
            this.hideForm   = true;
            this.sendNotification(`Congratulations the bike: ${bikeModel} was successfully added`);
         }
   ...
   updateEntry(bikeModel, bikeRate, Description, bikeID)
   {
      ...
      .subscribe(data =>
      {
         ...
         {
            this.hideForm  =  true;
            this.sendNotification(`Congratulations the bike: ${bikeModel} was successfully updated`);
         }
         // Otherwise let 'em know anyway
         else
         {
